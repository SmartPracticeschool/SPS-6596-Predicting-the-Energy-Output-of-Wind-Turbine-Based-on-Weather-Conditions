...
def hello():
    if request.method == 'POST':
        ...
        url = "https://eu-gb.ml.cloud.ibm.com/ml/v4/deployments/b49cb9ba-53f4-484b-b2b7-9b6f8976b7ca/predictions?version=2020-11-05"
        ...
        payload_scoring = {"input_data": [
            {"fields": ['Wind Speed (m/s)', 'Theoretical_Power_Curve (KWh)', 'Direction'],
             "values": [[std_ws, std_tpc, std_wd,]]}]}
